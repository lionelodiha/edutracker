...
/** List part of SemestersPage — shared by the sessions route and AcademicStructurePage. */
export default function SessionsList({ organizationId }: { organizationId: string }) {
        ...
        <>
            <div className="dz-card" style={{ padding: 0, overflow: "hidden" }}>
                <div style={{ padding: "1.35rem 1.4rem 1rem", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem", flexWrap: "wrap" }}>
                    <div>
                        <div className="dz-card-title">Sessions</div>
