...
using EduTracker.Application.Features.OrganizationInvites.AcceptOrganizationInvite;
using EduTracker.Application.Models;

namespace EduTracker.Api.Endpoints.OrganizationInvites.Handlers.AcceptOrganizationInvite;
