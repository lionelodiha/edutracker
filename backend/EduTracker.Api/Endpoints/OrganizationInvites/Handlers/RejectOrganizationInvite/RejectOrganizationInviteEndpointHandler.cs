...
using EduTracker.Application.Features.OrganizationInvites.RejectOrganizationInvite;
using EduTracker.Application.Models;

namespace EduTracker.Api.Endpoints.OrganizationInvites.Handlers.RejectOrganizationInvite;
