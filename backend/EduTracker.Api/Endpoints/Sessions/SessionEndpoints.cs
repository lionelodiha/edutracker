...
internal static class SessionEndpoints
{
    ...
    {
        public void MapSessionEndpoints()
        {
            RouteGroupBuilder sessionGroup = app.MapGroup(ApiRoutes.Session.Base)
                .WithTags("Sessions");

            sessionGroup.MapGet(ApiRoutes.Session.Me, GetCurrentUserSessionsEndpointHandler.Handle)
            ...
            sessionGroup.MapPost(ApiRoutes.Session.Revoke, RevokeCurrentUserSessionEndpointHandler.Handle)
            ...
            sessionGroup.MapPost(ApiRoutes.Session.RevokeAll, RevokeAllCurrentUserSessionsEndpointHandler.Handle)
