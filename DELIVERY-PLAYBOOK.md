...
The one ordering exception: the **health endpoints** in Stage 06 are two hours
with no dependencies, and Part 2 needs them for container healthchecks and
rolling deploys. Pull those forward.
